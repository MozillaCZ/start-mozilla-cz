...
window.addEventListener('load', () => {
    const tips = [
        ...
        'Zavřeli jste si v SeaMonkey omylem panel prohlížeče? Klepněte nad ouškem panelu pravým tlačítkem myši a v místní nabídce zvolte <span class="nabidka">Obnovit zavřený panel</span>.',
